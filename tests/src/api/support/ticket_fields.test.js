const endpoint = require('../../../../src/api/support/ticket_fields');
...
describe('object types', () => {
  ...
  describe('create or update a ticket field option', () => {
    it('should process w/ valid input', () => {
      expect(
        endPoint.createOrUpdateOption({ field_id: 123, id: 456, data: {} })
      ).toEqual({
        method: 'POST',
        url: `${url}/api/v2/ticket_fields/123/options/456.json`,
        headers,
    ...
    it('should throw error w/ invalid input', () => {
      ...
      expect(() =>
        endPoint.createOrUpdateOption({ field_id: 123, id: 'invalid' })
      ).toThrowError();
      expect(() =>
        endPoint.createOrUpdateOption({
          field_id: 123,
          id: 456,
          data: 'invalid'
        })
