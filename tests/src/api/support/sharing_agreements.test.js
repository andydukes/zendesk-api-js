const endpoint = require('../../../../src/api/support/sharing_agreements');
...
describe('Sharing Agreements', () => {
  ...
  describe('List Sharing Agreements', () => {
  ...
  describe('Show a Sharing Agreement', () => {
    it('should process w/ valid input', () => {
      expect(endPoint.show({ id: 123 })).toEqual({
        method: 'GET',
        url: `${url}/api/v2/sharing_agreements/123.json`,
        headers
      });
    });
  ...
  describe('Create Sharing Agreement', () => {
    it('should process w/ valid input', () => {
  ...
  describe('Update a Sharing Agreement', () => {
    it('should process w/ valid input', () => {
  ...
  describe('Delete a Sharing Agreement', () => {
    it('should process w/ valid input', () => {
